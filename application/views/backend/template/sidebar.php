<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        $menuId = $m['id'];
            ...
            LEFT JOIN 	`user_sub2_menu` ON `user_sub_menu`.`id_sub2_menu` =  `user_sub2_menu`.`id_sub2_menu`
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav-<?= $sm['id_sub2_menu'] ?>"
                data-bs-toggle="collapse" href="#">
                <i class="<?= $sm['icon'] ?>"></i>
                <span><?= $sm['title'] ?></span>
                <i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="forms-nav-<?= $sm['id_sub2_menu'] ?>" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <!-- Submenu Items -->
                <?php foreach($subMenu as $sub): ?>
                <?php if($sub['id_sub2_menu'] === $sm['id_sub2_menu']): ?>
                <li>
